...
function ThirdPrize() {
  ...
  const winnersList = [
    { url: "/winner_posters/fourth_prize/fourth_prize_1.gif", title: "beach" },
    { url: "/winner_posters/fourth_prize/fourth_prize_2.gif", title: "beach" },
    { url: "/winner_posters/fourth_prize/fourth_prize_3.gif", title: "beach" },
    { url: "/winner_posters/fourth_prize/fourth_prize_4.gif", title: "beach" },
  ];
  ...
  return (
    <div className="grandpage">
      ...
      <div className="grandPrize">
        <img
          src="/bayers/bg/fourth_prize_1.gif"
      ...
      <div className="grandprize-down-portion">
        <img
          ...
          src="/bayers/bg/fourth_prize_2.png"
          alt=""
          loading="lazy"
        />
            ...
            <div className="grand-page-card-container">
              <div className="card" onClick={handleCardClick}>
                <div className="card-image-container">
                  <img
                    src="/bayers/cards/fourth_prize.gif"
