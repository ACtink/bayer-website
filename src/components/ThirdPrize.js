...
function ThirdPrize() {
  ...
  const winnersList = [
    { url: "/bayers/winner_posters/4th_1.gif", title: "beach" },
    { url: "/bayers/winner_posters/4th_2.gif", title: "beach" },
    { url: "/bayers/winner_posters/4th_3.gif", title: "beach" },
    { url: "/bayers/winner_posters/4th_4.gif", title: "beach" },
  ];
