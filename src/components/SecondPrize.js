...
function SecondPrize() {
  ...
  const winnersList =[{ url: "/winners/3rd_1.gif", title: "beach" },
  { url: "/winners/3rd_2.gif", title: "beachhhh" }]
  ...
  return (
    <div className="grandpage">
      ...
      <div className="grandPrize">
        <img src="/bayers/bg/third_prize_1.gif" className="grandprize-image" alt="" />
      </div>
      <div className="grandprize-down-portion">
         <img className="grand-down-image" src="/bayers/bg/third_prize_2.png" alt="" />
